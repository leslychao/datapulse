...
@RestController
@RequestMapping(value = "/api/workspaces/{workspaceId}/offers/{offerId}/promo-journal",
        produces = MediaType.APPLICATION_JSON_VALUE)
@RequiredArgsConstructor
public class PromoJournalController {

    private final PromoJournalService journalService;

    @GetMapping
    @PreAuthorize("@workspaceAccessService.isCurrentWorkspace(#workspaceId)")
    public Page<PromoJournalEntryResponse> getPromoJournal(
