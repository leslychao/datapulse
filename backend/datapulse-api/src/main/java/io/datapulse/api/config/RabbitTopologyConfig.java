...
public class RabbitTopologyConfig {
  ...
  public Declarables rabbitTopology() {
    ...
    var priceReconciliationExchange = new DirectExchange(PRICE_RECONCILIATION_EXCHANGE, true,
        false);
    var priceReconciliationWaitExchange = new DirectExchange(PRICE_RECONCILIATION_WAIT_EXCHANGE,
        true, false);
