...
/**
 * WB Statistics Orders: paginated via {@code lastChangeDate} cursor.
  ...
  public List<CaptureResult> captureAllPages(CaptureContext context, String apiToken,
    ...
    while (pageNumber < MAX_PAGES) {
      ...
      try {
        ...
        log.info("WB orders: end of data: connectionId={}, page={}",
      ...
      pageNumber++;
      log.debug("WB orders page captured: connectionId={}, page={}, cursor={}, byteSize={}",
          context.connectionId(), pageNumber, currentDateFrom, page.captureResult().byteSize());
    }

    log.info("WB orders capture completed: connectionId={}, dateFrom={}, totalPages={}",
