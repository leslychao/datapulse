...
@EtlSourceMeta(
    events = { MarketplaceEvent.SALES_FACT, MarketplaceEvent.FACT_FINANCE},
    marketplace = MarketplaceType.OZON,
    rawTableName = RawTableNames.RAW_OZON_POSTINGS_FBS
)
public class OzonPostingsFbsEventSource implements EventSource {
  ...
  public List<Snapshot<?>> fetchSnapshots(
    ...
    while (true) {
      Snapshot<OzonPostingFbsRaw> snapshot =
          ozonAdapter.downloadPostingsFbsPage(accountId, dateFrom, dateTo, offset, PAGE_LIMIT);
