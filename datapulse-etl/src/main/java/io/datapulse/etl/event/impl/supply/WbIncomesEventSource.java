package io.datapulse.etl.event.impl.supply;
...
@EtlSourceMeta(
    events = { MarketplaceEvent.SUPPLY_ACCEPTED_FACT },
    marketplace = MarketplaceType.WILDBERRIES,
    rawTableName = RawTableNames.RAW_WB_INCOMES
)
public class WbIncomesEventSource implements EventSource {
  ...
  public List<Snapshot<?>> fetchSnapshots(
    ...
    while (true) {
      Snapshot<WbIncomeRaw> snapshot = wbAdapter.downloadIncomesPage(accountId, cursor);
