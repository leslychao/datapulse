...
@EtlSourceMeta(
    ...
    rawTableName = RawTableNames.RAW_WB_OFFICES_FBS
)
public class WbOfficeFbsEventSource implements EventSource {
  ...
  public List<Snapshot<?>> fetchSnapshots(
    ...
    Snapshot<WbOfficeFbsListRaw> snapshot =
        wbAdapter.downloadFbsOffices(accountId);
