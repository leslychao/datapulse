...
public final class ValidationKeys {
  ...
  public static final String USER_PROFILE_EMAIL_REQUIRED =
      "{" + MessageCodes.USER_PROFILE_EMAIL_REQUIRED + "}";
  ...
  public static final String ACCOUNT_MEMBER_USER_ID_REQUIRED =
      "{" + MessageCodes.ACCOUNT_MEMBER_USER_ID_REQUIRED + "}";
