...
public class PersistAdapter implements PersistencePort {
  ...
  public Account saveAccount(Account account) {
    ...
    if (entity.getTokenEncrypted() == null) {
      entity.setTokenEncrypted("DEV_PLACEHOLDER");
    }
    entity.setCreatedAt(ZonedDateTime.now(ZoneId.of("Europe/Moscow")).toOffsetDateTime());
  ...
  public void upsertSalesBatch(List<Sale> salesBatch) {
    if (salesBatch == null || salesBatch.isEmpty()) {
      return;
    }
